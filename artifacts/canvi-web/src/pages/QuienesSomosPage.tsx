...
const titulars = [
  ...
  { initials: "SP", name: "Sergi Pérez Serra", role: "Membre del Consell", photo: img("sergi.jpg"), scale: 1.5, objectPosition: "50% 0%" },
  ...
  { initials: "ÓS", name: "Óscar Sáez Martín", role: "Membre del Consell", photo: img("oscar.jpg"), objectPosition: "50% 0%" },
  { initials: "MP", name: "Marina Peiro Comba", role: "Representant FCJE", photo: img("marina.jpg"), objectPosition: "50% 20%" },
