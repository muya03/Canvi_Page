...
const titulars = [
  ...
  { initials: "PV", name: "Pau Valcárcel Redón", role: "Membre del Consell", photo: img("pau_valcarcel.jpg"), objectPosition: "50% 20%" },
  { initials: "LG", name: "Lydia Gómez López", role: "Representant FCS" },
  { initials: "ÓS", name: "Óscar Sáez Martín", role: "Membre del Consell", photo: img("oscar.jpg"), objectPosition: "50% 30%" },
  { initials: "MP", name: "Marina Peiro Comba", role: "Representant FCJE", photo: img("marina.jpg"), objectPosition: "50% 55%" },
  { initials: "FS", name: "Favio Scarfo Manzaneda", role: "Representant FCS", photo: img("favio.jpg"), objectPosition: "50% 15%" },
  { initials: "VN", name: "Valeria Nuño Gil", role: "Representant ESTCE", photo: img("valeria.jpg") },
  { initials: "VC", name: "Valentín Carpentier Anglés", role: "Representant FCJE", photo: img("valentin.jpg"), objectPosition: "50% 15%" },
  { initials: "NG", name: "Nagore García Miravet", role: "Representant ESTCE", photo: img("nagore.jpg") },
  { initials: "GV", name: "Germán Valderrama García", role: "Representant FCJE", photo: img("german_valderrama.jpg"), objectPosition: "50% 15%" },
  { initials: "YE", name: "Yousra Reklaoui El Hadri", role: "Representant ESTCE", photo: img("yousra.jpg") },
  { initials: "JC", name: "Joan Cerezuela Soto", role: "Representant FCS", photo: img("joan_cerezuela.jpg"), objectPosition: "50% 20%" },
  ...
  { initials: "AM", name: "Alejandro Morera Canet", role: "Representant ESTCE", photo: img("alejandro_morera.jpg"), objectPosition: "50% 15%" },
  { initials: "MA", name: "Mohamed Al Howaidi Nasralla", role: "Membre del Consell", photo: img("mohamed.jpg") },
  { initials: "SB", name: "Santiago Bernabé Hernández", role: "Membre del Consell", photo: img("santiago.jpg") },
];
...
const suplents = [
  ...
  { initials: "MM", name: "Manuel Morrondo Bielsa", photo: img("manuel_morrondo.jpg"), objectPosition: "50% 20%" },
  { initials: "CZ", name: "Christopher Ziolkowski Gilgado", photo: img("christopher.jpg"), objectPosition: "50% 10%" },
  { initials: "CM", name: "Claudia Martín Fernández" },
  { initials: "AIM", name: "Álvaro Ionut Moraru", photo: img("alvaro.jpg") },
