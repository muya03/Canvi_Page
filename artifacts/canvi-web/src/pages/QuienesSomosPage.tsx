...
const titulars = [
  ...
  { initials: "ÓS", name: "Óscar Sáez Martín", role: "Membre del Consell", photo: img("oscar.jpg"), objectPosition: "50% 5%" },
  { initials: "MP", name: "Marina Peiro Comba", role: "Representant FCJE", photo: img("marina.jpg"), objectPosition: "50% 40%" },
